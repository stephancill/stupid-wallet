...
#if os(iOS) || os(tvOS) || os(watchOS)
    typealias BlockiesColor = UIColor
#elseif os(OSX)
    typealias BlockiesColor = NSColor
#endif

// MARK: - Color HSL Extension
extension BlockiesColor {
    ...
    static func fromHSL(h: Double, s: Double, l: Double) -> BlockiesColor? {
        return BlockiesColor(h: h, s: s, l: l)
    }
}

// MARK: - Blockies Implementation
public final class Blockies {
    ...
    #if os(iOS) || os(tvOS) || os(watchOS)
    public typealias BlockiesNativeColor = UIColor
    public typealias Image = UIImage
    #elseif os(OSX)
    public typealias BlockiesNativeColor = NSColor
    public typealias Image = NSImage
    #endif

    public var color: BlockiesNativeColor
    public var bgColor: BlockiesNativeColor
    public var spotColor: BlockiesNativeColor
     ...
     */
        ...
        size: Int = 8,
        scale: Int = 4,
        color: BlockiesNativeColor? = nil,
        bgColor: BlockiesNativeColor? = nil,
        spotColor: BlockiesNativeColor? = nil
    ) {
        ...
        self.size = size
        self.scale = scale
        self.color = color ?? BlockiesNativeColor.clear
        self.bgColor = bgColor ?? BlockiesNativeColor.clear
        self.spotColor = spotColor ?? BlockiesNativeColor.clear
    ...
    private func createColor() -> BlockiesNativeColor {
        ...
        return BlockiesColor(h: h, s: s, l: l) ?? BlockiesNativeColor.black
    }
    ...
    private func image(data: [Double], customScale: Int) -> Image? {
        ...
        for i in 0 ..< data.count {
            ...
            let uiColor: BlockiesNativeColor
            if number == 0 {
                uiColor = bgColor
            } else if number == 1 {
                uiColor = color
                ...
                uiColor = BlockiesNativeColor.black
            }
